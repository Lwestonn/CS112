...
public class ForgeStormBreaker {
	public static void main (String [] args) {
        ...
        String forgeStormbreakerInput = args[0];
        String forgeStormbreakerOutput = args[1];
        
	    // Set the input file.
        StdIn.setFile(forgeStormbreakerInput);
      ...
      //  int[][] arr = new int[rows][col];
        ...
        // WRITE YOUR CODE HERE TO CALCULATE THE FLUX USING THE INPUT FILE
            ...
            for(int i = 0;i<rows;i++){
                for(int j = 0;j<col;j++){
                    totalFlux+=StdIn.readInt();
                }
            }
            
        // Set the output file.
        StdOut.setFile(forgeStormbreakerOutput);
